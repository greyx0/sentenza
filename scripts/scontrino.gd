...
@export var item_id: String = "receipt"
...
@onready var sprite_1 = $scontrino
@onready var sprite_2 = $scontrino_1
@onready var sprite_3 = $scontrino_2
...
func trigger_sequence_sconto_1(choice_id: int):
	sprite_1.visible = false
...
func trigger_sequence_sconto_2(choice_id: int):
	sprite_1.visible = false
