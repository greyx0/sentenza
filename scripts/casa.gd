...
@export var item_id: String = "house"
...
@onready var sprite_1 = $casa_0
@onready var sprite_2 = $casa_1
@onready var sprite_3 = $casa_2
...
func trigger_sequence_house_1(choice_id: int):
	sprite_1.visible = false
...
func trigger_sequence_house_2(choice_id: int):
	sprite_1.visible = false
