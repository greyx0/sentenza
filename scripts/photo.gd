...
@export var item_id: String = "photo"
...
@onready var sprite_1 = $photo
@onready var sprite_2 = $photo_framed
@onready var sprite_3 = $photo_burned
...
func trigger_sequence_framed(choice_id: int):
	sprite_1.visible = false
...
func trigger_sequence_burned(choice_id: int):
	sprite_1.visible = false
