...
@export var item_id: String = "condoms"
...
@onready var sprite_1 = $preservativi
@onready var sprite_2 = $preservativi_1
@onready var sprite_3 = $preservativi_2
...
func trigger_sequence_pre_1(choice_id: int):
	sprite_1.visible = false
...
func trigger_sequence_pre_2(choice_id: int):
	sprite_1.visible = false
