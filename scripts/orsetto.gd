...
@export var item_id: String = "bear"
...
@onready var sprite_1 = $orsetto
@onready var sprite_2 = $orsetto_1
...
func trigger_sequence_orsetto_1(choice_id: int):
	sprite_1.visible = false
...
func trigger_sequence_orsetto_2(choice_id: int):
	sprite_1.visible = false
